...
namespace SomethingNeedDoing
{
    public unsafe class EventHandler : IDisposable
    {
        ...
        private bool IsLoggedIn => Service.ClientState.IsLoggedIn;
        ...
        public EventHandler(EquipmentScanner equipmentScanner)
        {
            ...
            Service.ClientState.Login += ClientStateOnOnLogin;
            Service.ClientState.Logout += ClientStateOnOnLogout;
        }

        private void SetAddonNowLoading()
        {
            addonLoading = (AtkUnitBase*)Service.GameGui.GetAddonByName("NowLoading", 1);
        }
